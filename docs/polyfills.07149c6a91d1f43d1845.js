    ...
    [429],
    {
        277: () => {
            ...
            const b = 'undefined' != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope,
                ...
                E = void 0 !== _.process && '[object process]' === {}.toString.call(_.process) && !b && !(!g || !k.HTMLElement),
                Z = {},
                S = function (e) {
            ...
            Zone.__load_patch('ZoneAwarePromise', (e, t, n) => {
                ...
                function Z(e, o, s) {
                    ...
                    if (e[g] === v) {
                        ...
                        if (o !== T && s instanceof C && s.hasOwnProperty(g) && s.hasOwnProperty(k) && s[g] !== v) D(s), Z(e, s[g], s[k]);
                            ...
                            e[g] = o;
                            const c = e[k];
                            if (((e[k] = s), e[_] === _ && o === b && ((e[g] = e[y]), (e[k] = e[m])), o === T && s instanceof Error)) {
                    ...
                    _ = function (t) {
                        ...
                        if (o)
                            if (1 === o.length) k(o[0], n, t);
                                ...
                                const e = o.slice();
                                for (let o = 0; o < e.length && (!t || !0 !== t[q]); o++) k(e[o], n, t);
                            }
                    },
                    m = function (t) {
                        if (!(t = t || e.event)) return;
                    ...
                    const C = s
                        ...
                        N = function (t, n, r, i, c = !1, h = !1) {
                            return function () {
                                ...
                                const _ = L && !!M && -1 !== M.indexOf(f),
                                    m = O(arguments[2], _);
                                if (R)
                                    for (let e = 0; e < R.length; e++)
                                        if (f === R[e]) return _ ? t.call(p, f, d, m) : t.apply(this, arguments);
                                ...
                                const N = s ? A : void 0;
                                N && (N.taskData = w);
                                const x = E.scheduleEventTask(D, d, N, r, i);
                                return (
                                    (w.target = null),
                                    N && (N.taskData = null),
                                    v && (m.once = !0),
                ...
                Zone.__load_patch('XHR', (e, t) => {
                    !(function (e) {
                        ...
                        function m(e) {
                            ...
                            (a[s] = !1), (a[l] = !1);
                            const u = a[r];
                            p || ((p = a[i]), (g = a[c])), u && g.call(a, k, u);
                            const h = (a[r] = () => {
                                if (a.readyState === a.DONE)
                                    if (!o.aborted && a[s] && e.state === _) {
                            ...
                            return p.call(a, k, h), a[n] || (a[n] = e), E.apply(a, o.args), (a[s] = !0), e;
                        }
                        function y() {}
                        function v(e) {
                            const t = e.data;
